...
const koa_oas3_1 = require("koa-oas3");
exports.default = (path) => {
    return koa_oas3_1.oas({
        file: path,
        ...
        errorHandler: (error, ctx) => {
            ...
            if (error.name === "ResponseValidationError") {
                ctx.throw(501, Object.assign({ request: { method: ctx.method, url: ctx.url } }, JSON.parse(JSON.stringify(error))));
            }
